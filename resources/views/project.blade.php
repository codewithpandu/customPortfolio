<x-layout :title="$title">
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-6 grid md:grid-cols-2 lg:grid-cols-3 gap-2 h-full">
            @foreach ($projects as $project)
                <div class="p-4 sm:mb-0 mb-6 border rounded-lg h-full flex flex-col ">
                    ...
                    <div class="flex justify-between mt-auto">
                        ...
                        <a target="_blank" href="{{ $project->url }}" class="text-brand inline-flex items-center mt-3">Demo
