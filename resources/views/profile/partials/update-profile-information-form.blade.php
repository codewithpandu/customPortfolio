<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <x-text-input id="username" name="username" type="text" class="mt-1 block w-full" :value="old('username', $user->name)" required autofocus autocomplete="name" />
        ...
        <div class="mt-4">
            ...
            <input
                ...
                aria-describedby="avatar" id="avatar" type="file" name="avatar"
                accept="image/jpg, image/png, image/jpeg">
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="avatar">SVG, PNG, JPG or GIF (MAX.
                800x400px).
            </p>
            @error('avatar')
