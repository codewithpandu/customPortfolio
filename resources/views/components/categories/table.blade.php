...
<section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 antialiased">
    ...
    <div class="mx-auto max-w-7xl px-4 lg:px-12">
        ...
        <div class="bg-white dark:bg-gray-800 relative sm:rounded-lg overflow-hidden">
            ...
            <div class="mt-4">
                <table class="w-sm text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3 flex items-center justify-end">
                                    ...
                                    <div id="category-{{ $category->id }}-dropdown"
                                        ...
                                        <ul class="py-1 text-sm"
                                            ...
                                            <li>
                                                <button href="/categories/{{ $category->slug }}/edit"
                                            ...
                                            <li>
                                                <button type="submit" data-modal-target="deleteModal-{{ $category->id }}"
